...
useEffect(()=>{
        ...
        setProductoFiltrado(productos.find((p) => p.id == id))
...
console.log(productoFiltrado)
    ...
    return (
        <div>
            <ItemDetail url={productoFiltrado.url} precio={productoFiltrado.precio} detail={productoFiltrado.detail} nombre={productoFiltrado.nombre}/>
        </div>
    )
}
